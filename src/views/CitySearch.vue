<template>
  <div>
    <!-- Add favorite-cities component to the template. Bind the favorites value to the favoriteCities property. -->
...
// Add Favorite Cities child component import statement here
...
export default {
  ...
  components: {
    ...
    // Add FavoriteCities child component here
  ...
  created() {
    // Retreive the `favoriteCities` value from localstorage using this.$ls.get()
  ...
  methods: {
    saveCity: function(city) {
      // Add logic to add the city to the this.favorites array and to add the city to the favoriteCities array
